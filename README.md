...
## 用python实现GIS处理
[轨道客流可视化！shapely初探](轨道客流可视化！shapely初探.ipynb)  
[用道路切分地块！shapely的线转面处理！](用道路切分地块！shapely的线转面处理！.ipynb)
## 爬虫
...
15. [社区发现！Fast unfolding算法分析出租车社区！](社区发现！Fast unfolding算法分析出租车社区！.ipynb)
