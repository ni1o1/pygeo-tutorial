...
<div class="alert alert-info">上次导师跟我说：小旭啊，我们这个项目你给我出800张图吧，我这周五就要。这个其实画出来也没什么用，放我们项目文本的附录里显示我们的工作量<br>
<br>
我当场把桌子掀起来，画你妹！老子这博不读了<br>
不，以上是做梦，我微笑着说，好的老师，我通宵画<br>
</div>  
现在，python出现了，有了python里面的pandas，geopandas，matplotlib包，只需要用python就能实现数据的批量计算，批量出gis图等等。  
  
哇！太棒了！简直是读研、读博、设计院画图、数据分析、闲着没事、居家旅行时候都必须会的技能
